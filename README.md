...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.8423555.svg)](https://doi.org/10.5281/zenodo.8423555)<!-- do not change; always points to the latest release -->

## Study Design

<img src="./misc_files/study_overview.svg" alt="Study Overview" width="600">

## Repository Description

_See [below](#how-to-cite) for citation information._
...
> Mike Lape and Kevin Ernst. (2025). WeirauchLab/pathogen_ncd. 
> Zenodo. https://doi.org/10.5281/zenodo.8423555

The associated manuscript is [Lape, _et al_., _Communications Medicine_
2025][commmed]:
...
Center and Mike Lape. Web site source code (the `web` subdirectory) is &copy;
