# Name:     ukb_titer_analysis.R
# Author:   Mike Lape
# Date:     01/17/2023
# Description:
#
#   This program reads in several files that have been previously prepared
#   using the jupyter notebook ukb_data_cleaning_pub.ipynb, representing
...
# res will contain the model results and metadata for each disease-antibody pair
...
std_dat = as.data.frame(read_excel('./misc_files/tier1_and_tier2_standards_w_notes.xlsx'))
...
htmlwidgets::saveWidget(dt, paste('./ukb_mod_results_', OUT_FILE_DATE, '.html', sep = ''))
