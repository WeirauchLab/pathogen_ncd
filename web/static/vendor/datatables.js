 ...
 *   https://datatables.net/download/#dt/dt-2.3.2/b-3.2.3/b-html5-3.2.3/fh-4.0.2
 *
 * Included libraries:
 *   DataTables 2.3.2, Buttons 3.2.3, HTML5 export 3.2.3, FixedHeader 4.0.2
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.3.2/b-3.2.3/b-html5-3.2.3/fh-4.0.2",
